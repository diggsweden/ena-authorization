...
| anvisningstjänst | Ingår vanligtvis som funktion i en digital tjänst hos *förlitande part* och syftar till att stötta användaren i val av identitetsintygstjänst. | En användare kan företräda sig själv eller någon annan fysisk eller juridisk person. |
...
| federation för identitets- och behörighetshantering | Ett antal aktörer som i avtalad samverkan delar information kring identiteter och behörighetsgrundande information i en federativ kontext, som definieras med hjälp av gemensamt bestämda regler avseende teknik, datasemantik, tillitsramverk, legala tolkningar samt federationsövergripande organisatoriska regler och policyer. |  |
| federation för informationsutbyte | Ett antal aktörer som i avtalad samverkan delar information i ett gemensamt syfte med hjälp av gemensamt definierade regler för informationsutbytet både avseende teknik, datasemantik, tillitsramverk, legala tolkningar, samt federationsövergripande organisatoriska regler och policyer. | Även kallad *informationsfederation*. | 
| federationsanasvarig | Den aktör som ansvarar och koordinerar för federationens övergripande struktur, regler och villkor. Federationsansvarig agerar *tillitsankare* för anslutning av *federationsoperatör* och *utfärdare av tillitsmärken*. | | 
| federationsoperatör | En betrodd aktör som agerar utifrån delegering av *Federationsansvarig* för att hantera registrering av digitala tjänster i en eller flera federativa kontext. Federationsoperatören kan i sin tur delegera anslutning av digitala tjänster till underliggande *intermediära operatörer*. | | 
