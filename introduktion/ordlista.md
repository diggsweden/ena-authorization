...
| federation | Ett antal aktörer som i avtalad samverkan delar information i ett gemensamt syfte med hjälp av gemensamt definierade regler för informationsutbytet både avseende teknik, datasemantik, tillit, legala tolkningar samt federationsövergripande organisatoriska regler och policyer. | Se även en [utförligare beskrivning](federationer.md). | 
