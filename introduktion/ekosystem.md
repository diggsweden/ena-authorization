...
| Användning | **Behov**: <br />:white_check_mark: Digitala tjänster som är användbara och tillgängliga. <br /><br />**Funktioner**: <br />:exclamation: smarta infrastrukturstjänster som erbjuder helt sömlösa eller smidiga övergångar vid realisering av integrationer i den digitala infrastrukturen. |
